...
public class Main {
    ...
    static Agent agent_3 = new Agent(new int[]{2, 1, 1}, new int[]{4, 3, -1, 6, 2, 2}, "agent 3", 3);
    ...
    static List<Agent> all_Agent = List.of(new Agent[]{agent_1, agent_2, agent_3, agent_4, agent_5, agent_6});
    static List<Agent> allAgentManager = List.of(new Agent[]{agent_3, agent_4});
    static List<Agent> allAgentContractor = List.of(new Agent[]{agent_1, agent_2, agent_5, agent_6});
    ...
    public static void main(String[] args) {
        ...
        FunctionGA.randomTeam(2,agent_4);
